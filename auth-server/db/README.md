...
Database to store Authorization Server data.
...
- **TASK_MANAGER_AUTH_SERVER_DB_ADMIN_USER:** Admin user (ex: admin);
- **TASK_MANAGER_AUTH_SERVER_DB_ADMIN_PASS:** Admin password (ex: admin);
- **TASK_MANAGER_AUTH_SERVER_DB_DB_NAME:** Database name (ex: auth_server);
- **TASK_MANAGER_AUTH_SERVER_DB_PORT:** Connection port (ex: 4002);
